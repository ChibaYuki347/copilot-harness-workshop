...
repo as the **first** governance signal the agent sees. Inspired by the
"社内 ROCKS" pattern mentioned in the 2026-05-26 planning session — a single
short page that codifies the team's non-negotiables, named in a way the agent
