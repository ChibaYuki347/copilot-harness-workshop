...
## Bridging from last week's class

If your team did the 2026-05-26 Foundry walkthrough, this recipe is the
"now use it from Copilot" sequel. The Foundry capabilities you saw demoed
(Content Understanding, PII, translator) are the same APIs — Copilot just
gets typed access to them via MCP, instead of you running curl examples.
