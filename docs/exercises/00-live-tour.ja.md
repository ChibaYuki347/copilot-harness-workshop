...
??? note "ファシリテーターのキュー"
    ...
    承認プロンプトの形を画面で walk through: ツール名、全引数、
    [a]llow / [A]llow always / [d]eny / [q]uit。引数全文表示の意味を強調 — 
    deny が最後の防衛線。
...
- これは 2026-06-02 Copilot ワークショップ用の scratch リポ
