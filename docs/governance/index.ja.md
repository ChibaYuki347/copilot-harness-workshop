...
ところが **2026 年 6 月 2 日の社内レクチャー** の参加者層はその逆 — ほぼ全員が
Copilot Chat の Ask モードを毎日使う一方で、**Agent モードを試したことがある人は
1 名のみ** という状況です。最大の理由は「取り返しのつかないことが起きそう」
というリスク不安。このセクションはそれに対する直接の回答です。
